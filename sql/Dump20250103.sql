...
CREATE TABLE `conference_application` (
  ...
  CONSTRAINT `application_sido` FOREIGN KEY (`sido`) REFERENCES `conference_sido` (`code`),
  CONSTRAINT `application_sigu` FOREIGN KEY (`sigungu`) REFERENCES `conference_sigu` (`code`)
...
LOCK TABLES `conference_application` WRITE;
/*!40000 ALTER TABLE `conference_application` DISABLE KEYS */;
INSERT INTO `conference_application` VALUES (8,1,'2024-12-12 22:44:52','서울 송파구 중대로 121','2층','엑스퍼트test','05718','010-1234-1234','test@exc.co.kr','테스트이름','테스트직급',1,NULL,NULL,0,NULL,0,0,'[\"123\"]','[\"기업규모--50인 미만\", \"기업업종--서비스업\", \"채용 및 교육을 위한<br />직무기술서를 보유하고 있습니까?--예\", \"직무별 평가 역량을 보유하고 있습니까?--예\", \"컨설팅 대상 기업으로 선정 시<br />희망하는 착수 일정을 표기해주십시오.--2분기 (3~6월)\"]','110','117');
/*!40000 ALTER TABLE `conference_application` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `conference_info` (
  ...
  `conference_addition_input_info` TEXT DEFAULT NULL,
  `conference_addition_input_info_value` TEXT DEFAULT NULL,
...
--
-- Table structure for table `conference_sido`
--

DROP TABLE IF EXISTS `conference_sido`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `conference_sido` (
...
--
-- Dumping data for table `conference_sido`
--

LOCK TABLES `conference_sido` WRITE;
/*!40000 ALTER TABLE `conference_sido` DISABLE KEYS */;
INSERT INTO `conference_sido` VALUES ('100','강원도'),('110','경기도'),('120','경상남도'),('130','경상북도'),('140','광주광역시'),('150','대구광역시'),('160','대전광역시'),('170','부산광역시'),('180','서울특별시'),('190','세종특별자치시'),('200','울산광역시'),('210','인천광역시'),('220','전라남도'),('230','전라북도'),('240','제주특별차지도'),('250','충청남도'),('260','충청북도');
/*!40000 ALTER TABLE `conference_sido` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `conference_sigu`
--

DROP TABLE IF EXISTS `conference_sigu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `conference_sigu` (
  `code` varchar(5) NOT NULL,
  `name` varchar(45) DEFAULT NULL,
  `parent_code` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`code`),
  KEY `sigu_sido_idx` (`parent_code`),
  CONSTRAINT `sigu_sido` FOREIGN KEY (`parent_code`) REFERENCES `conference_sido` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `conference_sigu`
--

LOCK TABLES `conference_sigu` WRITE;
/*!40000 ALTER TABLE `conference_sigu` DISABLE KEYS */;
INSERT INTO `conference_sigu` VALUES ('1','성북구','180'),('10','중구','180'),('101','강남구','180'),('104','고양시','110'),('11','도봉구','180'),('115','포천시','110'),('117','안성시','110'),('12','은평구','180'),('13','서초구','180'),('14','노원구','180'),('144','광명시','110'),('149','군포시','110'),('15','서대문구','180'),('151','파주시','110'),('16','중라구','180'),('161','양주시','110'),('167','평택시','110'),('17','용산구','180'),('173','광주시','110'),('18','강북구','180'),('187','성남시','110'),('189','이천시','110'),('19','성동구','180'),('198','연천군','110'),('2','송파구','180'),('20','종로구','180'),('21','금천구','180'),('213','용인시','110'),('215','의정부시','110'),('22','광진구','180'),('225','시흥시','110'),('226','하남시','110'),('23','구로구','180'),('232','안양시','110'),('237','가평군','110'),('239','수원시','110'),('24','동작구','180'),('243','양평군','110'),('245','화성시','110'),('262','동두천시','110'),('281','구리시','110'),('296','의왕시','110'),('3','마포구','180'),('301','오산시','110'),('305','여주시','110'),('324','과천시','110'),('340','안산시','110'),('345','남양주시','110'),('347','부천시','110'),('349','김포시','110'),('4','동대문구','180'),('5','영등포구','180'),('6','양천구','180'),('7','관악구','180'),('8','강동구','180'),('9','강서구','180');
/*!40000 ALTER TABLE `conference_sigu` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-01-03 14:29:43
